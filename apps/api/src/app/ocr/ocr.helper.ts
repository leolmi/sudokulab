...
export const preProcessImage = async (context: OcrContext) => {
  if (context.debug)
    console.log(`[ocr] Preprocessing: raw image ${context.raw!.length} bytes`);

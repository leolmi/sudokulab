...
export const AVAILABLE_IMAGE_TYPE = [
  'image/png',
  'image/jpeg',
  'image/jpg',
  'image/jpe',
...
export const isImageType = (type: string): boolean =>
  AVAILABLE_IMAGE_TYPE.indexOf(type) > -1;
...
export const getImageByFile = (
  ...
  reader.onerror = (err) =>
    console.error(...SDK_PREFIX, 'error reading image file', err);

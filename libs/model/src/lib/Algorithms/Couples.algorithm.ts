import {difference as _difference, forEach as _forEach, intersection as _intersection, remove as _remove} from 'lodash';
          ...
          if (!o.done[cid_XY]) {
            ...
            if (XY.length === 2) {
              ...
              g_XYZ?.cells.forEach((cid_YZ) => {
                ...
                if (!o.done[cid_YZ] && cid_YZ !== cid_XY && YZ.length === 2 && Y.length === 1) {
                  ...
                  getAllGroups(sdk, [cid_YZ]).find(g_YZX => {
                    if (g_YZX.id !== g_XYZ.id) {
                      ...
                      g_YZX.cells.forEach(cid_ZX => {
                        ...
                        if (!o.done[cid_ZX] && cid_ZX !== cid_YZ && YZ.length === 2 && Z.length === 1) {
